export const CardContent = [
  {
    id: "1",
    header: "Ut excepteur do duis ex duis.",
    title: "This is a title",
    summary:
      "Sunt incididunt elit laborum elit. Incididunt elit ut dolor proident Lorem sunt elit ad. Dolor excepteur velit dolore pariatur dolore eiusmod officia Lorem.",
    text:
      "Sint tempor in duis do aliquip aliquip esse deserunt ea. Irure reprehenderit excepteur ipsum sunt irure irure commodo. Veniam minim labore consectetur elit amet eu eu nulla eiusmod. Sit ut enim magna velit. Consequat esse id pariatur nostrud incididunt nisi consequat culpa tempor non. Dolor minim ut consequat tempor ad dolor laboris excepteur culpa.",
  },
  {
    id: "2",
    header: "Eiusmod Lorem magna Lorem deserunt est.",
    title: "Quis fugiat amet consequat deserunt anim.",
    summary:
      "Ullamco aute est aliqua deserunt. Commodo irure minim cupidatat reprehenderit ipsum sit deserunt. Sit ea commodo dolore qui mollit do aliqua pariatur.",
    text:
